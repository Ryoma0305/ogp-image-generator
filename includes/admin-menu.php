...
if( $original_image_id && $font_url && $font_size && $ogp_font_color && $ogp_new_line_char_length ){
    ...
    $preview_image_url = plugins_url('/ogp-image-generator') . '/img/preview/ogp-example.jpg?' . date('YmdHis');
    ...
    update_option(self::PLUGIN_PREVIEW_IMAGE_URL, $preview_image_url);
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="ogp_font_url" type="text" value="<?php echo esc_attr($ogp_font_url) ?>" style="width:60%; margin-top:4px;" readonly="readonly"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="ogp_font_size" type="number" id="ogp_font_size" value="<?php echo esc_attr($ogp_font_size) ?>" class="regular-text"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input_ogp_font_color" name="ogp_font_color" type="color" id="ogp_font_color" value="<?php  echo esc_attr($ogp_font_color) ?>" class="regular-text"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="ogp_new_line_char_length" type="number" id="ogp_new_line_char_length" value="<?php  echo esc_attr($ogp_new_line_char_length) ?>" class="regular-text"/>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="original_image" type="hidden" value="<?php echo esc_attr($original_image) ?>" readonly="readonly"/>
                            <div id="ogp_image_url_thumbnail" class="uploded-thumbnail">
                            <?php foreach ($ogp_image_urls as $key => $url): ?>
                                <input name="original_image_id" type="text" value="<?php echo esc_attr($url) ?>" style="width:60%; margin-top:4px;" readonly="readonly"/>
                            <?php endforeach ?>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="preview_sample_text" type="text" id="preview_sample_text" value="<?php echo esc_attr($ogp_preview_sample_text) ?>" class="regular-text" style="display:block; margin-bottom:8px; width: 530px;"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="box"><img src="<?php echo esc_url($ogp_preview_image_url); ?>" alt="" style="height:280px;"/></div>
                        </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
